...
def generateCSV(sc: SupplyChain) -> tuple[bool, str]:
    ...
    header = ['Lane Name', 'Customer Name', 'Supplier Name', 'Transport Cost', 'Lane Cost']
    data = []
    ...
    for lane in lanes:
        ...
        data.append([lane_name, lane_customer.name, lane_supplier.name, lane_transport_cost, lane_cost])
